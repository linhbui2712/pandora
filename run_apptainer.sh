...
export EXEC="apptainer exec -B $PGDATA:/var/lib/postgresql/data -B $PGRUN:/var/run/postgresql -B $PGDATA:/var/lib/postgresql/18/docker -B $(pwd):/pandora -e -C apptainer/images/pandora.sif"
